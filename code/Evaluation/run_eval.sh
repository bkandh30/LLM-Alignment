...
#SBATCH -o /scratch/bkandhar/dm_proj/logs_directory/logs/your_runname.out                       # STDOUT (%j = JobId)
#SBATCH -e /scratch/bkandhar/dm_proj/logs_directory/logs/your_runname.err                       # STDERR (%j = JobId)
